                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" id="mdate_of_birth" type="text" placeholder="Enter your birthday" value="{{ old('date_of_birth')  ??  $cv->date_of_birth?? '' }}" required>
                                    @error('date_of_birth')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" id="phone_number" type="text" placeholder="Enter your phone_number" value="{{ old('phone_number')  ??  $cv->phone_number?? '' }}" required>
                                    @error('phone_number')
                                        <span class="invalid-feedback" role="alert">
